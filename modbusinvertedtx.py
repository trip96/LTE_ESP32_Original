...
class Modbus:
    ...
    def __init__(self):
        ...
        s.init(baudrate=9600, bits=8, parity=None, stop=1, rx=21, tx=22, invert=UART.INV_TX)  # init with given parameters
    ...
    def init(self):
        s.init(baudrate=9600, bits=8, parity=None, stop=1, rx=21, tx=22)
