#
# MODIFIED FOR SERIAL TTL OVER TCP BY JORDAN FOR ASCON CONTROLLERS
# AT MINUS FORTY TECHNOLOGIES USING SOCKETS FILTERING 0XFF PROBLEM.
#
# Second Revision removes TCP and used library JUST for UART - TTL - Modbus RTU conversation.
...
class Modbus:
    ...
    def __init__(self):
        ...
        # rx=16, tx=17 for non cell ESP32. RX=22, TX=23 for cellular chips.
